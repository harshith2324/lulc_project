...
# Model
print("Loading ViT-S/16 with Sentinel-2 pretrained weights...")
...
for epoch in range(EPOCHS):
    ...
    for batch in train_loader:
        ...
        # UC Merced is RGB (3 bands), repeat to get 13 bands
...
results.to_csv('./results/ucmerced/vit_ucmerced.csv', index=False)
print("\nResults saved to results/ucmerced/vit_ucmerced.csv")
